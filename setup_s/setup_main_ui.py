...
"")
        ...
        self.doubleSpinBox_PixelSize = QtWidgets.QDoubleSpinBox(self.tab_LaserProfiler)
        self.doubleSpinBox_PixelSize.setDecimals(3)
        self.doubleSpinBox_PixelSize.setMinimum(0.001)
        self.doubleSpinBox_PixelSize.setSingleStep(0.5)
        self.doubleSpinBox_PixelSize.setProperty("value", 1.0)
        self.doubleSpinBox_PixelSize.setObjectName("doubleSpinBox_PixelSize")
        self.horizontalLayout.addWidget(self.doubleSpinBox_PixelSize)
        self.label = QtWidgets.QLabel(self.tab_LaserProfiler)
        ...
        self.horizontalLayout_10.addWidget(self.pushButton_LP_LoadRaw)
        ...
        SetupMainWindow.setTabOrder(self.checkBox_LP_gaussian_manual, self.scrollArea)
    ...
    def retranslateUi(self, SetupMainWindow):
        ...
        self.label.setText(_translate("SetupMainWindow", "um (Pixel Size)"))
