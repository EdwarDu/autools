...
"")
        ...
        self.doubleSpinBox_MapM_X1.setMinimum(-50.0)
        self.doubleSpinBox_MapM_X1.setMaximum(50.0)
        self.doubleSpinBox_MapM_X1.setSingleStep(1.0)
        self.doubleSpinBox_MapM_X1.setProperty("value", 10.0)
        ...
        self.doubleSpinBox_MapM_X0.setMinimum(-50.0)
        self.doubleSpinBox_MapM_X0.setMaximum(50.0)
        self.doubleSpinBox_MapM_X0.setSingleStep(1.0)
        ...
        self.doubleSpinBox_MapM_Y0.setMinimum(-50.0)
        self.doubleSpinBox_MapM_Y0.setMaximum(50.0)
        self.doubleSpinBox_MapM_Y0.setSingleStep(1.0)
        ...
        self.doubleSpinBox_MapM_Y1.setMinimum(-50.0)
        self.doubleSpinBox_MapM_Y1.setMaximum(50.0)
        self.doubleSpinBox_MapM_Y1.setSingleStep(1.0)
        self.doubleSpinBox_MapM_Y1.setProperty("value", 10.0)
        ...
        self.spinBox_MapM_NSamplesAvgLockIn = QtWidgets.QSpinBox(self.tab_MapMeasurements)
        self.spinBox_MapM_NSamplesAvgLockIn.setMinimum(1)
        self.spinBox_MapM_NSamplesAvgLockIn.setObjectName("spinBox_MapM_NSamplesAvgLockIn")
        self.horizontalLayout_15.addWidget(self.spinBox_MapM_NSamplesAvgLockIn)
        self.label_76 = QtWidgets.QLabel(self.tab_MapMeasurements)
        ...
        self.spinBox_MapM_NSamplesAvgPD = QtWidgets.QSpinBox(self.tab_MapMeasurements)
        self.spinBox_MapM_NSamplesAvgPD.setMinimum(1)
        self.spinBox_MapM_NSamplesAvgPD.setMaximum(50000)
        self.spinBox_MapM_NSamplesAvgPD.setSingleStep(100)
        self.spinBox_MapM_NSamplesAvgPD.setProperty("value", 1500)
        self.spinBox_MapM_NSamplesAvgPD.setObjectName("spinBox_MapM_NSamplesAvgPD")
        self.horizontalLayout_15.addWidget(self.spinBox_MapM_NSamplesAvgPD)
        ...
        self.checkBox_ShowPreLine = QtWidgets.QCheckBox(self.tab_MapMeasurements)
        self.checkBox_ShowPreLine.setObjectName("checkBox_ShowPreLine")
        self.horizontalLayout_15.addWidget(self.checkBox_ShowPreLine)
        ...
        self.pushButton_MapM_Pause = QtWidgets.QPushButton(self.tab_MapMeasurements)
        self.pushButton_MapM_Pause.setObjectName("pushButton_MapM_Pause")
        self.horizontalLayout_15.addWidget(self.pushButton_MapM_Pause)
        ...
        self.tab_PDVMeasurement = QtWidgets.QWidget()
        self.tab_PDVMeasurement.setObjectName("tab_PDVMeasurement")
        self.verticalLayout_3 = QtWidgets.QVBoxLayout(self.tab_PDVMeasurement)
        self.verticalLayout_3.setObjectName("verticalLayout_3")
        self.horizontalLayout_13 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_13.setSpacing(10)
        self.horizontalLayout_13.setObjectName("horizontalLayout_13")
        self.label_21 = QtWidgets.QLabel(self.tab_PDVMeasurement)
        self.label_21.setObjectName("label_21")
        self.horizontalLayout_13.addWidget(self.label_21)
        self.comboBox_PhotoDiode_NIDAQ_Channel = QtWidgets.QComboBox(self.tab_PDVMeasurement)
        ...
        self.pushButton_PDV_Refresh = QtWidgets.QPushButton(self.tab_PDVMeasurement)
        ...
        self.pushButton_PDV_AutoRefresh = QtWidgets.QPushButton(self.tab_PDVMeasurement)
        ...
        self.comboBox_PDV_Interval = QtWidgets.QComboBox(self.tab_PDVMeasurement)
        ...
        self.label_22 = QtWidgets.QLabel(self.tab_PDVMeasurement)
        ...
        self.widget_PDVPlot = PDVPlotWidget(self.tab_PDVMeasurement)
        self.widget_PDVPlot.setObjectName("widget_PDVPlot")
        self.verticalLayout_3.addWidget(self.widget_PDVPlot)
        self.verticalLayout_3.setStretch(1, 1)
        self.tabWidget.addTab(self.tab_PDVMeasurement, "")
    ...
    def retranslateUi(self, SetupMainWindow):
        ...
        self.label_75.setText(_translate("SetupMainWindow", "LockIn#.Avg"))
        self.label_76.setText(_translate("SetupMainWindow", "PD#.Avg"))
        ...
        self.checkBox_ShowPreLine.setText(_translate("SetupMainWindow", "Show Last Line"))
        self.pushButton_MapM_Auto.setText(_translate("SetupMainWindow", "Auto Measure"))
        self.pushButton_MapM_Pause.setText(_translate("SetupMainWindow", "Pause"))
