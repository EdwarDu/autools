...
class SetupMainWindow(Ui_SetupMainWindow):
    ...
    def __init__(self):
        ...
        self.widget_CamImage.refresh()  # this is force calculate d values
    ...
    def lp_image_rotation_a_changed(self, a):
        self.widget_CamImage.img_rotate_angle = a
    ...
    def cam_single_shot(self):
        if self.current_cam is not None:
            ...
            if frame is not None:
                self.widget_CamImage.update_image_data(frame)
    ...
    def lp_load_raw(self):
        ...
        if fname is not None and fname != '':
            self.widget_CamImage.load_raw(fname)

    def lp_pixel_size_changed(self, psz):
        self.widget_CamImage.pixel_size = psz
